...
const profile = () => {
    ...
    const saveSocials = e =>{
        e.preventDefault();
        fetch(`https://linkspectrum-backend.onrender.com/save/socials`,{
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
    ...
    useEffect(()=>{
        if(!localStorage.getItem('LinkSpectrumToken')) return router.push('/login');
        fetch(`https://linkspectrum-backend.onrender.com/load/socials`,{
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
    ...
    return (
        <>
            ...
            <main >
                ...
                <div>
                    <h4 className='font-bold text-center mb-5 p-3 mt-2'>Edit profile</h4>
                    <div>
                ...
                <div className='mt-14'>
                    ...
                    <form onSubmit={saveSocials} className='flex flex-col justify-center items-center'>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            ...
                            <input id="facebook" value={social.facebook} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Facebook Profile" required/>
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/instagram.svg" alt="" />
                            <input id="instagram" value={social.instagram} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Instagram Profile" required/>
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/twitter.svg" alt="" />
                            <input id="twitter" value={social.twitter} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Twitter Profile" required/>
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/linkedin.svg" alt="" />
                            <input id='linkedin' value={social.linkedin} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Linkedin Profile" required/>
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/github.svg" alt="" />
                            <input id='github' value={social.github} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter Github Profile" required/>
                        </span>
                        <span className='flex flex-row mb-3 w-11/12 m-auto shadow-md border-2 px-3 py-2 rounded-md focus:outline-none'>
                            <img className='w-6 mr-2' src="/svg/youtube.svg" alt="" />
                            <input id='youtube' value={social.youtube} onChange={handleSocial} className='focus:outline-none w-full' type="text" placeholder="Enter YouTube Profile" required/>
                        </span>
