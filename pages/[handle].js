...
import LinkTree from '../components/LinkSpectrum'
import Link from 'next/link';
import SocialTree from '../components/SocialTree'
import ShareButton from '../components/ShareButton'
import LinkSpectrum from '../components/LinkSpectrum';
...
const Handle = () => {
    ...
    useEffect(()=>{
        if(router.query?.handle){
            fetch(`https://linkspectrum-backend.onrender.com/get/${router.query.handle}`)
            .then(res=>res.json())
            .then(data=>{
